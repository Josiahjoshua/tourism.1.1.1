      ...
      <div class="tab-content sidebar-tabing" id="nav-tabContent">
          ...
          <div class="tab-pane active" id="news" role="tabpanel">
            @foreach ( $news_articles as $article )
              ...
              <div class="media">
                  <a href="{% url 'mynews:article_detail' language=current_language article_id=article.id %}">
                      <img class="d-flex mr-3" src="{{$article->img}}" alt="Thumbnail">
                  </a>
                  <div class="media-body">
                      <div class="news-title">
                          <h2 class="title-small pt-0 mt-0">
                              <a href="{% url 'mynews:article_detail' language=current_language article_id=article.id %}" class="link-no-underline">{{$article->name}}</a>
                          </h2>
                      </div>
              ...
              <div class="row justify-content-center mt-2">
                  <a href="{% url 'mynews:all_articles' language=current_language %}" class="link-no-underline"> <i>Tazama Zote <i class="far fa-arrow-alt-circle-right"></i></i></a>
              </div>
          </div>
          ...
          <div class="tab-pane" id="products" role="tabpanel">
            @foreach ( $resources_products as $product)
              ...
              <div class="media">
                  <a href="{{ route('mynews.article_detail', ['language' => $current_language, 'article_id' => $article->id]) }}">
                      <img class="d-flex mr-3" src="{{$product->img}}" alt="Thumbnail">
                  </a>
                  <div class="media-body">
                      <div class="news-title">
                          <h2 class="title-small pt-0 mt-0">
                              <a href="{% url 'myproducts:product_detail' language=current_language product_id=product.id %}" class="link-no-underline">{{$product->name}}</a>
                          </h2>
                      </div>
            ...
            @endforeach
              ...
              <div class="row justify-content-center mt-2">
                  {{-- <a href="{% url 'myproducts:all_products' language=current_language %}" class="link-no-underline"> <i>Tazama Zote <i class="far fa-arrow-alt-circle-right"></i></i></a> --}}
              </div>
          </div>
