      ...
      <div class="tab-content sidebar-tabing" id="nav-tabContent">
          ...
          @foreach($news_articles as $article)
              ...
              <div class="row justify-content-center mt-2">
                  {{-- <a href="{{ route('mynews.all_articles', ['language' => $current_language]) }}" class="link-no-underline"> <i>Tazama Zote <i class="far fa-arrow-alt-circle-right"></i></i></a> --}}
              </div>
          </div>
          ...
          <div class="tab-pane" id="products" role="tabpanel">
            @foreach($resources_products as $product)
              ...
              <div class="row justify-content-center mt-2">
                  {{-- <a href="{{ route('myproducts.all_products', ['language' => $current_language]) }}" class="link-no-underline"> <i>Tazama Zote <i class="far fa-arrow-alt-circle-right"></i></i></a> --}}
              </div>
          </div>
