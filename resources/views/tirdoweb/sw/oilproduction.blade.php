            ...
            <div class="col-12 p-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 bg-white py-3 page-content">
                        <h4>UZALISHAJI MUHIMU WA MAFUTA</h4>
                            <br>
                            <p>
                                TIRDO imetekeleza mradi wa utafiti wa uongezaji thamani kwenye maganda ya chungwa ambayo yangepotea kuzalisha mafuta muhimu (Orange Sweet Essential Oil).
                                 Pia uongezaji wa thamani kwenye Eucalyptus kuzalisha Mafuta Muhimu huku vivyo hivyo kwenye Cardamon kuzalisha Mafuta Muhimu.
                            </p>
                            <h5>
