        ...
        <div class="article">
            ...
            <p class="mt-2">
                ...
                <div class="row align-content-center mt-3">
                    ...
                    <a href="{{ asset('storage/' . $publication->file ) }}" class="ml-5 link-no-underline" download="{{asset('storage/' . $publication->file) }}" onclick="window.location.href='{{ asset('storage/' . $publication->file ) }}'"><i class="fa fa-download" style="color: #006f8b;"></i> Download</a>
                </div>
